      ...
      <form @submit.prevent="submitForm" class="cadastro-form">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <input type="date" id="dataContratacao" v-model="formData.DataContratacao" required>
          </div>
  
          <div class="form-group">
            <label for="salario">Salário*</label>
            <input type="number" id="salario" v-model="formData.Salario" 
        ...
        try {
          ...
          const payload = {
            ...
            funcionario: {
              ...
              DataContratacao: this.formData.DataContratacao,
              Salario: parseFloat(this.formData.Salario),
          ...
          console.log("Dados para cadastro de funcionário:", payload);
