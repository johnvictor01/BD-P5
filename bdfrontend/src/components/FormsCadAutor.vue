  ...
  <div class="cadastro-container">
    ...
    <form @submit.prevent="submitForm" class="cadastro-form">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            ...
            <select id="estado" v-model="formData.Estado" required>
              ...
              <option v-for="(estado, sigla) in estadosBrasil" :value="sigla">
                {{ estado }}
              </option>
            </select>
          </div>
      ...
      <fieldset>
        ...
        <div class="form-group">
          <label for="matricula">Sua matrícula será gerada automaricamente*</label>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            required
          />
          <span v-if="senhasNaoConferem" class="error-message"
      ...
      try {
        ...
        try {
          const response = await axios.post(
            "http://localhost:5000/cadastro-autor",
            payload,
            {
              withCredentials: true, // Para enviar cookies de sessão se necessário
            }
          );

          if (response.data.success) {
            alert(
              `Autor cadastrado com sucesso! Matrícula: ${response.data.matricula}`
            );
            this.resetForm();
          } else {
        ...
        alert(
          "Ocorreu um erro ao cadastrar o autor. Por favor, tente novamente."
        );
      } finally {
